pipeline {
    ...
    environment {
        ...
        AMI_ID = "nancy-blog-ami-${BUILD_NUMBER}"
        ...
        stage('Get Infrastructure Outputs') {
            steps {
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding',
                    ...
                    terraform output -raw blog_db_endpoint || echo "N/A"
                    ...
                    echo ""
                    echo "ASG Name:"
                    terraform output -raw blog_asg_name
        ...
        stage('Build Vulnerability Report (Inspector2)') {
            ...
            steps {
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding',
                    ...
                    ASG_NAME=\$(terraform output -raw blog_asg_name)
